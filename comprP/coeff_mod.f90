module coeff
real(kind=8) :: Ra,Di,Grueneisen=1.0,DiG,DiRa,Ra_orig,Rb_local
integer :: iqtype,ichoice_init_temp  
integer, parameter :: NLAYMAX=10
real(kind=8) :: q_layer(NLAYMAX),q_layer_d(NLAYMAX)
logical :: compress,TALA=.false.,EBA,BA,divufromeos,quad903,quad903_use_funcc3,quad800,ivl_smoothstep=.false.
...
logical :: step_rho_background,exp_rho_background,stretch_tracers


logical :: tosi15,tackley,tackley2000,tackley_newvis
