module control
  ...
  logical :: print_node,conductive,read_velocity,stokes_is_updated,restart,stokes_only=.false.,do_not_do_Stokes=.false.
  integer :: irestart,krestart
  logical :: printmatrix,pedebug,petiming,delta1K,Kequivalent,petest=.false.,check_on_curved_elements,temperature_in_C
  integer :: subdivide800,subdivide900
  logical :: no_temperature_solution,do_temperature_solution,noGMT=.true.,compute_curl_v=.false.,tracers_are_set_up=.false.
  ...
  logical :: chiTisinvrhobar=.false.,CY85_Eq22=.true.,add_dynamic_pressure_term_to_work,cian_ALA=.false.,cpisnotcv=.true.
  ...
  integer :: npvkalloc=0
  logical :: stop_after_initialize_temp_vel=.false.,stop_after_first_real_Stokes=.false.
...
! bstore.inc
  ...
  ! pecpu
  real(kind=4) :: t00=0.0,t1=0.0,t2=0.0,t3=0.0,cput,cpustart_iteration,cputhis_iteration,cpuend_iteration
  ...
  ! pesteady
  real(kind=8) :: eps,relax,relaxtosi,dif1,dif2,dif
